...
/// let tokenizer = Tokenizer::from_path("nerdstash_tokenizer_v2.json").expect("Failed to read tokenizer file");
/// let tokens: Vec<u32> = tokenizer.encode("Hello, World!");
/// assert_eq!(tokens, [13071, 49231, 2553, 49338]);
/// let word: String = tokenizer.decode(tokens);
